...
follows:
1. Calculate the difference $(di = y_i âˆ’ x_i)$ between the two observations on each pair,
...
Under the null hypothesis, this statistic follows a t-distribution with $n âˆ’ 1$ degrees of freedom.
