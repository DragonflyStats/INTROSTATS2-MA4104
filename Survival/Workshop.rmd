---
title: "Workshop on Survival Analysis"
output:
  html_document:
    fig_caption: yes
    number_sections: yes
...
# Re-using some code from Sec 1 of the workshop to avoid repeating myself in later worksheets.
...
* The content of this workshop is based on the book "Applied Survival Analysis Using R" by Dirk F. Moore. 
* The data from this book is available from CRAN via the package `asaur`.
...
# Part 2: Estimations of the Survival Functions
