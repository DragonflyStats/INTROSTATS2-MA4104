...
\begin{itemize}
\item Lecture 1: Monday 15-16 in Room ERB001
\item Lecture 2: Thursday 17-18 in Room FB028
\item No classes on Bank Holiday Monday and during the open days.
\item Tutorials - New timetable.
\end{itemize}
...
\begin{itemize}
\item Lecture notes : available on SULIS system or by email.
...
\item Mid Term is provisionally scheduled for Thursday (Week 8).
\item I will re-arrange the date if needs be.
\item Past papers will be made available through the SULIS system or by email.
\end{itemize}
}
%-------------------------------------------------------%
